...
public class WorkspaceAuthorizationService {
    ...
    public boolean isUserMemberOfWorkspace(String workspaceId, String userId) {
        return memberRepository.existsByWorkspaceIdAndUserId(workspaceId, userId);
    }

    public boolean isWorkspaceAdminOrMember(String workspaceId, String userId) {
        return isOwnerOrAdmin(workspaceId, userId) || hasAccess(workspaceId, userId);
    }
