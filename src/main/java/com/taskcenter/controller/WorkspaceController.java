...
public class WorkspaceController {
    ...
    public ApiResponse<UserDto> addMemberToWorkspace(
            @PathVariable String workspaceId,
            @RequestParam String userId,
            @AuthenticationPrincipal User currentUser) {
        return ApiResponse.success("User workspacega qo'ldirildi", workspaceService.addMemberToWorkspace(workspaceId, userId, currentUser));
    }

    @DeleteMapping("/{workspaceId}/members/{userId}")
    public ApiResponse<Void> removeMemberFromWorkspace(
            @PathVariable String workspaceId,
            @PathVariable String userId,
            @AuthenticationPrincipal User currentUser) {
        workspaceService.removeMemberFromWorkspace(workspaceId, userId, currentUser);
        return ApiResponse.success("User workspacedan olib tashlandi", null);
    }
